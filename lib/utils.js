 ...
 * console.log(cookies.anonymous_session_id); // "uuid-..."
 */
 ...
 *
 * @example
 * const cookieString = createCookie('anonymous_session_id', 'uuid-...');
 ...
 *   { name: 'anonymous_session_id', value: 'uuid-...' }
 * ]);
